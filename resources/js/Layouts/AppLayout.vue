                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('paises.index')" :active="route().current('paises.index')">
                                    Paises
                                </NavLink>
                                <NavLink :href="route('departamentos.index')" :active="route().current('departamentos.index')">
                                    Departamentos
                                </NavLink>
                                <NavLink :href="route('ciudades.index')" :active="route().current('ciudades.index')">
                                    Ciudades
                                </NavLink>
                                <NavLink :href="route('barrios.index')" :active="route().current('barrios.index')">
                                    Barrios
                                </NavLink>
