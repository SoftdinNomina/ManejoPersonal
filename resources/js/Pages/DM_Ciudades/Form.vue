...
const uploadEvent = (callback) => {
        ...
        formArchivo.departamentoID = props.departamentoID;
        formArchivo.post(route('ciudades_import')
        , {
                onSuccess: () => {
                ...
                <div class="overflow-hidden bg-white shadow-sm rounded-xl">
                    <div class="p-6 border-b border-gray-200 ">
                        <div class="text-center mx-auto rounded-md p-2 bg-blue-700 text-white space-x-2 border-b-2 mb-8">
                            ...
                            <Button v-if="props.ciudad == null"  icon="pi pi-upload" class=" p-button-primary  p-button-sm float-right"  title="Importar" @click="visible = true"/>
                        </div>
